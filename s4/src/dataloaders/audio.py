...
class DX7Autoregressive(SequenceDataset):
    _name_ = 'dx7'
    ...
    def val_dataloader(self, **kwargs):
        return self.dataset.get_eval_dataloader(kwargs["batch_size"])
    def test_dataloader(self, **kwargs):
        return self.dataset.get_test_dataloader(kwargs["batch_size"])